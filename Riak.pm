...
my @fields = qw(converge_delay_last converge_delay_max converge_delay_mean converge_delay_min coord_redirs_total cpu_avg1 cpu_avg15 cpu_avg5 cpu_nprocs dropped_vnode_requests_total executing_mappers gossip_received handoff_timeouts ignored_gossip_total mem_allocated 
